...
def dashboard(request):
    ...
    user_books = Book.objects.filter(user=request.user).prefetch_related('book_authors__author')
...
class BookListView(ListView):
    ...
    def get_queryset(self):
        # This method is overridden to filter the books by the logged-in user
